...
const BabyVaccinationEditForm = ({baby,babyVaccination,onClose})=>{
    ...
    const [babyVaccinationId,setBabyVaccinationId] = useState(babyVaccination.id);
    ...
    return (<div className="vaccine-edit-card">
        <div className="card-header">
        <h3>
          Edit Baby Vaccination
        </h3>
        <button
        ...
        <div>
            ...
            <p className="py-1">Baby Vaccination Id: {babyVaccination.id}</p>
              <p className="py-1">Baby Vaccination Name: {babyVaccination.vaccineName}</p>
        ...
        <form >
              ...
              <button className="rounded bg-blue-400 p-1" onClick={handleVaccineEdit}>
                <b>Update</b>
              </button>
              <p>{updateMsg}</p>
        </form>
