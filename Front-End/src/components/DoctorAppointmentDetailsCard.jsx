  ...
  return (
    <div className="appointment-details-card flex flex-col p-none border-slate-100 border-4">
      ...
      <div className="card-content">
        ...
        <p><b>Parent Name</b> &emsp;: {appointment.parentName}</p>
        {/* <p>Sex: {appointment.sex}</p> */}
        <p><b>Appointed Midwife</b> &nbsp;: {appointment.midwifeName}</p>
        {(appointment.hasAppointment === "Pending")? <p><b>Requesting Date</b> &nbsp;: <b className="text-red-600">{appointment.scheduledTime.substring(0, 10)}</b></p>:<p><b>Sheduled Date</b> &emsp;: {appointment.scheduledTime.substring(0, 10)}</p>}
        {(appointment.hasAppointment === "Pending")? <p><b>Requesting Time</b> &nbsp;: <b className="text-red-600">{appointment.scheduledTime.substring(0, 10)}</b></p>:<p><b>Requesting Time</b> &emsp;: {appointment.scheduledTime.substring(11, 16)}</p>}
